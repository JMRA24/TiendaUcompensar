...
public final class ItemOrderHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView orderItemsCount;
  ...
  private ItemOrderHistoryBinding(@NonNull MaterialCardView rootView, @NonNull TextView orderDate,
      @NonNull TextView orderId, @NonNull TextView orderItemsCount, @NonNull TextView orderStatus,
  ...
  public static ItemOrderHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.orderItemsCount;
      TextView orderItemsCount = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemOrderHistoryBinding((MaterialCardView) rootView, orderDate, orderId,
          orderItemsCount, orderStatus, orderTotal);
    }
